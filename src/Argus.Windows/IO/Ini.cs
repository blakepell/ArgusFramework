...
namespace Argus.IO
{
    ...
    public class Ini
    {
        ...
        {
            IniFileLocation = iniFileLocation;
        }
        ...
        public string GetFromIni(string section, string entry)
        {
            ...
            GetPrivateProfileString(section, entry, "", sb, 1024, IniFileLocation);
        ...
        public bool WriteToIni(string section, string entry, string buf)
        {
            ...
            returnValue = WritePrivateProfileString(section, entry, buf, IniFileLocation);

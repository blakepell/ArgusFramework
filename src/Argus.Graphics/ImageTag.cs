...
namespace Argus.Graphics
{
    ...
    public class ImageTag
    {
        ...
        /// <summary>
        /// This is the background color to use underneath the text.  It is set to transparent as default.  Specifying any other color
        ...
        /// 3.)  AutoMultiColor:  Text text will potentially be multiple colors for each character based on the brightness of the upper left hand pixel of that character's position on the image.
        /// </summary>

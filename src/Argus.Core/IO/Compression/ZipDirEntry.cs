...
namespace Argus.IO.Compression
{
    ...
    public class ZipDirEntry
    {
        ...
        public static ZipDirEntry Read(System.IO.Stream s)
        {
            ...
            zde._LastModified = Argus.IO.Compression.Shared.PackedToDateTime(zde._LastModDateTime);
            ...
            zde._FileName = Argus.IO.Compression.Shared.StringFromBuffer(block, 0, block.Length);
            ...
            if (commentLength > 0)
            {
                ...
                n = s.Read(block, 0, block.Length);
                zde._Comment = Argus.IO.Compression.Shared.StringFromBuffer(block, 0, block.Length);
            }
            return zde;
        }

...
namespace Argus.Extensions
{
    ...
    public static class ListExtensions
    {
        ...
        /// <summary>
        /// Will concatinate all items in a string list.  The optional delimiter can be used to put a space in or any other delimiter required.
        /// </summary>
        /// <param name="lst"></param>
        ...
        public static List<string> FromDelimitedString(this List<string> ls, string buf, string delimiter)
        {
            ...
            for (int x = itemList.Count - 1; x >= 0; x += -1)
            {
                ...
                if (string.IsNullOrWhiteSpace(itemList[x]) == true)
                {
                    itemList.RemoveAt(x);
                }
            }
        ...
        private static Random _shuffleRng = new Random();

...
namespace Argus.Extensions
{
    ...
    public static class DataTableExtensions
    {
        ...
        public static void MergeXml(this DataTable dt, string filePathOne, string filePathTwo, string destinationPath)
        {
            ...
            {
                var mergeEx = new Exception("The XML files could not be read.  " + ex.Message, ex);
            ...
            {
                var mergeEx = new Exception("The XML files could not be merged.  " + ex.Message, ex);
            ...
            {
                var mergeEx = new Exception("The XML files could not be written.  " + ex.Message, ex);

	...
	public class Formatting
	{
		...
		public static string ReturnLinkHtml(string url, bool openInNewWindow, bool forceHttpFormat)
		{
			...
			if (forceHttpFormat == true)
			{
				...
				else if (url.Contains("http://") == false & url.Contains("www.") == true)
				{
		...
		public static string ReturnLinkHtml(Uri url, bool openInNewWindow)
		{
			...
			if (openInNewWindow == true)
			{
				sb.AppendFormat("<a href=\"{0}\" target=\"_blank\">{1}</a>", url.ToString(), url.ToString());
			}
			else {
				sb.AppendFormat("<a href=\"{0}\">{1}</a>", url.ToString(), url.ToString());
			}
		...
		public static string ReturnLinkHtml(Uri url, string displayText, bool openInNewWindow)
		{
			...
			if (openInNewWindow == true)
			{
				sb.AppendFormat("<a href=\"{0}\" target=\"_blank\">{1}</a>", url.ToString(), displayText);
			}
			else {
				sb.AppendFormat("<a href=\"{0}\">{1}</a>", url.ToString(), displayText);
			}
		...
		public static List<string> ReturnCapitalizedWords(string str)
		{
			...
			MatchCollection mc = Regex.Matches(str, "[A-Z][a-z]*");

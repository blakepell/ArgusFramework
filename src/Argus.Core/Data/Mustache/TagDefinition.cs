namespace Argus.Data.Mustache
{
    ...
    /// </summary>
    public abstract class TagDefinition : ITagDefinition
    {
        /// <summary>
        ...
        internal TagDefinition(string tagName, bool isBuiltIn)
        {
            ...
            {
                throw new ArgumentException("An attempt was made to define a parameter with a null or an invalid identifier.", nameof(tagName));
            }
        ...
        internal bool IsSetter => this.GetIsSetter();
        ...
        /// </summary>
        internal bool IsContextSensitive => this.GetIsContextSensitive();
        ...
        /// </summary>
        internal IEnumerable<TagParameter> Parameters => this.GetParameters();
        ...
        /// </summary>
        internal bool HasContent => this.GetHasContent();
        ...
        /// </summary>
        internal IEnumerable<string> ClosingTags => this.GetClosingTags();

        protected virtual IEnumerable<string> GetClosingTags()
        {
            return this.HasContent ? new[] { this.Name } : new string[] { };
        }

        /// <summary>
        /// Gets the tags that are in scope within the current tag.
        /// </summary>
        internal IEnumerable<string> ChildTags => this.GetChildTags();

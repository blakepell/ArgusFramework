...
{
    /// <summary>
    /// Defines a tag that conditionally prints its content, based on whether the passed in values are not equal
    /// </summary>
    internal sealed class NeqTagDefinition : ConditionTagDefinition
    {
        private const string ConditionParameter = "condition";
        private const string TargetValueParameter = "targetValue";

        /// <summary>
        /// Initializes a new instance of a <see cref="NeqTagDefinition"/>.
        /// </summary>
        public NeqTagDefinition()
            : base("neq")
        { }
        ...
        private bool IsConditionSatisfied(object condition, object targetValue)
        {
            ...
            // If they are of different types and not both numeric, they are equal
            return true;
        }
